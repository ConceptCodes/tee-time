...
export const buildEdgeCaseScenarios = (clubs: ClubInfo[], count: number): EvalScenario[] => {
  ...
  const templates: Array<{
    ...
    { id: "edge-very-long-message", name: "Message at WhatsApp 1600 char limit", turns: [`Book ${clubText} tomorrow at 2pm for 1 player. Notes: ${"a".repeat(1500)}`], expect: { flow: "booking-new", decisionTypes: ["review", "ask"] } },
