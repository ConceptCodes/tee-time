...
const cancelBookingTemplates: Array<{
  ...
  { 
    id: "cancel-tomorrow", 
    name: "Cancel tomorrow's booking", 
  ...
  { 
    id: "cancel-specific-date",
    name: "Cancel specific date", 
  ...
  { 
    id: "cancel-next-booking", 
    name: "Cancel next booking", 
